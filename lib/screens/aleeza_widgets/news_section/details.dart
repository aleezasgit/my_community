...
class NewsDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Exact paragraphs content dataset extracted from your image template layout profiles
    ...
    return Scaffold(
      ...
      extendBodyBehindAppBar: true, // Forces scrolling layers to blend cleanly beneath the clear App Bar
