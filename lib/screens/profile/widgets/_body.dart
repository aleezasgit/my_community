    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
        ...
        trailingWidget: Row(
          ...
          children: [
            SvgPicture.asset('assets/svgs/settings.svg', width: 24.w, height: 24.h),
            Space.xf(12)!,
            SvgPicture.asset('assets/svgs/chat.svg', width: 24.w, height: 24.h),
            Space.xf(12)!,
            SvgPicture.asset('assets/svgs/notification_badge.svg', width: 24.w, height: 24.h),
          ],
        ),
      ),
